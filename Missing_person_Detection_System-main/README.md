  ...
  2. Install the core backend requirements inside the Conda environment:
  ...
  3. Install GPU-specific runtime packages after the base requirements:
...
2. Use a CUDA-enabled base image. Edit `backend/Dockerfile`:
   ```dockerfile
